...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mLu jones yak mas bro ? \033[1;91m: \033[1;92m")
	if nama =="":
...
def loginSC():
	...
	if username =="Mr.Orx" and password =="kafa":
